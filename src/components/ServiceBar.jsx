...
function ServiceBar() {
  return (
    <section className="h-72 sm:h-44 md:h-44 w-full bg-light-pink flex items-center justify-center">
      <ul className="sm:flex flex-wrap w-full md:flex items-center justify-between md:p-8 m-4">
        <li className="flex justify-start pl-20 pb-4 sm:flex items-center space-x-3">
